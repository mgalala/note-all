...
public class BrowseNotes extends ActionBarActivity
    ...
    public void onNavigationDrawerItemSelected(int position, String mCurrentSelectedCategory) {
        ...
        fragmentManager.beginTransaction()
                .replace(R.id.container, PlaceholderFragment.newInstance(position + 1, mCurrentSelectedCategory))
                .commit();
    }
...
//            getMenuInflater().inflate(R.menu.browse_notes, menu);
//            restoreActionBar();
//            return true;
//        }
...
//    }
    ...
    public static class PlaceholderFragment extends Fragment {
         ...
         * number.
         */
        public static PlaceholderFragment newInstance(int sectionNumber, String mCurrentSelectedCategory) {
        ...
        public void onAttach(Activity activity) {
            ...
            //((BrowseNotes) activity).onSectionAttached(getArguments().getInt(ARG_SECTION_NUMBER));
        }
    }
